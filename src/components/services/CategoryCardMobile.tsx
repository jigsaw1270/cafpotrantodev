    ...
    >
      <Link href={`/services/${category.slug}`}>
        <div className="category-card-mobile">
          <div className="mobile-card-content">
            <h3 className="mobile-back-title font-family-general-sans">
              {category.name.length > 20
                ? `${category.name.substring(0, 20)}...`
                : category.name}
            </h3>
            <div className="mobile-services-count">
              <span>{displayCount} servizi disponibili</span>
            </div>
            <p className="mobile-back-description">
      ...
      <style jsx>{`
        .category-card-mobile {
          ...
          /* Exact back-side background from desktop version */
        ...
        /* Background image styling - exact replica from back-side */
        ...
        /* Dark overlay for readability - exact replica */
        ...
        /* Content styling - exact replica of back-content */
        .mobile-card-content {
          position: relative;
          width: 100%;
          height: 100%;
        ...
        /* Title styling - exact replica of back-title */
        .mobile-back-title {
          font-size: 20px;
          font-weight: 700;
          margin-bottom: 8px;
        ...
        /* Services count styling - exact replica of services-count-back */
        ...
        /* Description styling - exact replica of back-description */
        ...
        /* CTA styling - exact replica of cta-text */
        .mobile-cta-text {
          display: flex;
          align-items: center;
          gap: 8px;
        ...
        /* CTA hover effect for mobile touch */
        .category-card-mobile:active .mobile-cta-text {
