...
const Loader = ({ size = 'medium', centered = false }: LoaderProps) => {
  ...
  return (
    <div className={`loader-wrapper ${centered ? 'centered' : ''}`}>
      <svg
        aria-label="Loading..."
        role="img"
        height={getSize()}
      ...
      >
        ...
        <g transform="translate(2,2)">
          ...
          <g transform="translate(13.75,9.25)" className="loader__model">
            ...
            <rect height={2} width="24.5" fill="hsl(var(--hue, 200),90%,50%)" />
            <rect
              height={1}
              width="19.5"
              y="0.5"
              ...
              ry="0.5"
              rx="0.5"
              fill="hsl(var(--hue, 200),90%,57.5%)"
            />
            <rect
              height={2}
              width="24.5"
              y="31.5"
              fill="hsl(var(--hue, 200),90%,50%)"
            />
            <rect
              height={1}
              width="19.5"
