      ...
      <div className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <motion.div
            ...
            className="bg-card mb-8 rounded-xl border p-6"
          >
          ...
          >
            ...
            <div className="space-y-4 text-left">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-foreground font-medium">Elaborazione</h3>
                  <p className="text-muted-foreground text-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-foreground font-medium">Contatto</h3>
                  <p className="text-muted-foreground text-sm">
          ...
          >
            ...
            <div className="flex flex-col justify-center gap-4 md:flex-row">
              <Link
                href="/"
                className="text-muted-foreground hover:text-foreground flex items-center justify-center gap-2 transition-colors"
              >
